...
namespace Sample.IncidentBot.Bot
{
    ...
    public class Bot
    {
        ...
        public const string RecordResponsePromptName = "RecordResponse";
        ...
        public Bot(BotOptions options, IGraphLogger graphLogger)
        {
            ...
            this.MediaMap[TransferingPromptName] = new MediaPrompt
            {
                ...
                {
                    Uri = new Uri(audioBaseUri, "audio/testing4.wav").ToString(),
            ...
            this.MediaMap[RecordResponsePromptName] = new MediaPrompt
            {
                MediaInfo = new MediaInfo
                {
                    Uri = new Uri(audioBaseUri, "audio/speech.wav").ToString(),
                    ResourceId = Guid.NewGuid().ToString(),
                },
            };
        ...
        public async Task<RecordOperationResult> RecordResponse(ICall call)
        {
            var bargeInAllowed = true;

            var prompts = new List<Prompt>()
            {
                MediaMap[RecordResponsePromptName]
            };

            var maxRecordDurationInSeconds = 60;

            var initialSilenceTimeoutInSeconds = 20;

            var maxSilenceTimeoutInSeconds = 3;
            ...
            return await call.Client.Calls()[call.Id]
                .RecordResponseAsync(maxRecordDurationInSeconds, initialSilenceTimeoutInSeconds, maxSilenceTimeoutInSeconds, bargeInAllowed, playBeep, prompts, stopTones);
        }
    }
}
