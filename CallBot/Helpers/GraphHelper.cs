...
namespace CallingBotSample.Helpers
{
    ...
    public class GraphHelper : IGraph
    {
        ...
        public GraphHelper(ILogger<GraphHelper> logger, IConfiguration configuration, IOptions<Users> users, IGraphServiceClient graphServiceClient)
        {
            this.logger = logger;
            this.configuration = configuration;
            this.users = configuration.GetSection("Users").Get<Configuration.User[]>().AsEnumerable();
            //this.users = users.Value.users;
